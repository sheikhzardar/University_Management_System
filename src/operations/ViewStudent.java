...
public class ViewStudent implements ActionListener
{
	...
	public ViewStudent() 
	{
		...
		lblheading = new JLabel("Students Detail");
		lblheading.setFont(new Font("Serif", Font.BOLD, 20));
		lblheading.setBounds(408, 27, 138, 27);
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==btnSearch)
		{
			...
			try 
			{
				...
				con=new Connect().connect();
				PreparedStatement pstmt = con.prepareStatement("SELECT * FROM students where roll_no = '"+roll+"'");
				ResultSet rs = pstmt.executeQuery();
				table.setModel(DbUtils.resultSetToTableModel(rs));
			}
			catch(Exception e)
