...
public class LeaveStudent implements ActionListener
{
	...
	public LeaveStudent()
	{
		...
		lblHeading = new JLabel("Apply For Student Leave");
		...
		lblRollno.setBounds(35, 110, 86, 18);
		...
		ImageIcon icon= new ImageIcon("images/st_leave.jpg");
		...
		btnCancel.setBounds(567, 41, 85, 25);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			Connection con=null;
			String rn=choice.getSelectedItem();
			...
			{
				con=new Connect().connect();
				String statement="INSERT INTO leaves_student VALUES ('"+rn+"','"+date+"','"+days+"','"+reason+"')";
